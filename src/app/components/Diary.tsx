    ...
    <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8" style={{ background: "var(--app-bg)" }}>
      {selectedEntry && (
        ...
        >
          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-4 py-4 sm:px-6" style={{ borderBottom: "1px solid var(--app-border)" }}>
              ...
              <div className="flex w-full sm:w-auto items-center gap-2">
                {!editingEntry && (
                  <>
                    <button
                      ...
                      className="flex flex-1 sm:flex-none items-center justify-center gap-2 px-3 py-2 rounded-xl"
                ...
                <button onClick={closeEntry} aria-label="Cerrar entrada" className="absolute right-3 top-3 p-2 rounded-xl sm:static" style={{ background: "none", color: "var(--app-text-muted)", border: 0 }}>
                  <X size={20} />
                </button>
              </div>
            </div>
            ...
            {editingEntry && (
              <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 px-4 sm:px-6 py-4" style={{ borderTop: "1px solid var(--app-border)" }}>
